...
- Enumarates the binary layers (archive files) and their unique SHA256 checksums
- Adds some metadata
...
For example, looking at the first and largest lyer:
