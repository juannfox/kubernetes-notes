...
A Kubernetes worker node is comprised of the Kubelet, a Container Runtime and a Kube-proxy instance, all components explained later in-depth. The following diagram depicts the node architecture:
