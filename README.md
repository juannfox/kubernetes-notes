# kubernetes-notes
Some **Spanish** Kubernetes notes related to CKA training (dated 2022).

Notas de Kubernetes para CKA en Español (2022).

*   1 [ ![:info:](https://pf-emoji-service--cdn.us-east-1.prod.public.atl-paas.net/atlassian/info_64.png) Conceptos](#:info:-Conceptos)
